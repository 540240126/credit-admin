      ...
      <nav class="nav">
        ...
        <div class="nav-center">
          <a class="nav-item hero-brand" href="/">
            ...
            <tooltip :label="'v0.0.1'" placement="right" type="success" size="small" :no-animate="false" :always="false" :rounded="true">
              <div class="is-hidden-mobile">
                <span class="vue">Credit</span><strong class="admin">Admin</strong>
              </div>
            </tooltip>
          </a>
        </div>
